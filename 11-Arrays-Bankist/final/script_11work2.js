...
// Callback függvény megírása külön
const deposit = mov => mov > 0;
console.log(accounts.movements.some(deposit));
console.log(accounts.movements.every(deposit));
console.log(accounts.movements.filter(deposit));
